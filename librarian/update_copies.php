	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>請輸入更新資訊</legend>
				...
				<div class="icon">
					<input class="b-copies" type="number" name="b_copies" placeholder="新增數量" required />
				</div>
						
				<input type="submit" name="b_add" value="更新" />
		</form>
	</body>
