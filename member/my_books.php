...
<html>
	...
	<body>
		...
		<?php
			...
			if($rows == 0)
				echo "<h2 align='center'>您的書架目前還是空的喔!!</h2>";
			else
			{
				...
				echo "</table><br />";
				echo "<input type='submit' name='b_return' value='還書' />";
				echo "</form>";
			}
			...
			if(isset($_POST['b_return']))
			{
				...
				{
					echo '<script>
							document.getElementById("success").innerHTML = "成功歸還 '.$books.' ";
					...
					echo error_without_field("請選擇一本書歸還");
			}
		?>
